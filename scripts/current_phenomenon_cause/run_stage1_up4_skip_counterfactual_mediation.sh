...
OUTPUT_ROOT="${OUTPUT_ROOT:-stage1_explanation_suite_20260517/results/e13_up4_skip_counterfactual_mediation_formal_n512}"
...
"${PYTHON_BIN}" -u guide_unet/process_analysis/stage1_up4_skip_counterfactual_mediation.py \
