...
OUTPUT_ROOT="${OUTPUT_ROOT:-stage1_explanation_suite_20260517/results/e4_faithfulness_perturbation}"
...
NODES="${NODES:-down3,down4,up1,up3,up4}"
...
"${PYTHON_BIN}" -u guide_unet/process_analysis/stage1_response_guided_perturbation.py \
