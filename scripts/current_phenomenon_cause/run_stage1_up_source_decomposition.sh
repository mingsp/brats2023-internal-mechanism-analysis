...
OUTPUT_ROOT="${OUTPUT_ROOT:-stage1_explanation_suite_20260517/results/e11_up_source_decomposition_formal_n512}"
...
"${PYTHON_BIN}" -u guide_unet/process_analysis/stage1_up_source_decomposition.py \
